...
public class JBeansTest {
  ...
  public void testOptionalGetter() {
    ...
    final Optional<Method> optionalGetFirstName =
        JBeans.optionalGetter(PersonBean.class, "firstName");
  ...
  public void testOptionalSetter() {
    ...
    final Optional<Method> optionalSetDeceased =
        JBeans.optionalSetter(PersonBean.class, "deceased");
  ...
  public void testInvokeSetter() {
    ...
    } catch (IllegalStateException | IllegalAccessException | IllegalArgumentException
