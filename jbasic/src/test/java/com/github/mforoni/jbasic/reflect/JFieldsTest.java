...
public class JFieldsTest {
  private static final Field IMMUTABLE_PERSON_FIRST_NAME =
      JFields.nonnull(ImmutablePerson.class, "firstName");
  ...
  private static final Field MUTABLEPERSON_GET_LASTNAME =
      JFields.nonnull(MutablePerson.class, "GET_LASTNAME");
