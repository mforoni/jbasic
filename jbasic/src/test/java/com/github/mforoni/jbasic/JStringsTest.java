...
public class JStringsTest {
  ...
  public void testNewArray() {
    ...
    assertArrayEquals(new String[] {"first", "second", "others"},
        JStrings.newArray("first", "second", "others"));
  }
  ...
  public void testSplitStringCharArray() {
    final String[] split =
        JStrings.split("A very long_text that need-to be split!", new char[] {' ', '_', '-'});
  ...
  public void testRemoveConsecutiveSpaces() {
    ...
    assertEquals("A very bad formatted text with too many spaces!", JStrings
        .removeConsecutiveSpaces("A   very bad formatted   text\t with too   many spaces!"));
  }
  ...
  public void testOccurrencesStringChar() {
    ...
    final String str2 =
        "This is a very long string that doesn't make sense but it is useful for writing a junit test";
