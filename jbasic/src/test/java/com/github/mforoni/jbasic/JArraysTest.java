...
public class JArraysTest {
	...
	public void testToStringTArray() {
		assertEquals("1,<null>,4,57,80,1900,-2", JArrays.toString(new Integer[] { 1, null, 4, 57, 80, 1900, -2 }));
		assertEquals("yes,<null>,2001-01-01,33.0", JArrays.toString(new Object[] { "yes", null, new LocalDate(2001, 1, 1), new Double("33") }));
	}
