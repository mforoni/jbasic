...
public class JLocalDatesTest {
  ...
  public final void testParseStringPattern() {
    ...
    assertEquals(new LocalDate(16, 3, 8),
        JLocalDates.parse(D03_08_16_SLASH, Pattern.MM_DD_YYYY_SLASH));
  }
  ...
  public final void testParseStringStringArray() {
    assertEquals(MARCH_8_2016,
        JLocalDates.parse(D3_8_2016_SLASH, JLocalDates.MONTH_DAY_YEAR_NUMERIC_DATE_FORMATS));
  }
  ...
  public final void testInferredLocalDatesStringStringArray() {
    assertTrue(JLocalDates.inferredLocalDates(D99_08_2013_SLASH, JLocalDates.NUMERIC_DATE_FORMATS)
        .size() == 0);
    ...
    assertTrue(JLocalDates.inferredLocalDates(D29_02_2018_SLASH, JLocalDates.NUMERIC_DATE_FORMATS)
        .size() == 0);
    assertTrue(JLocalDates.inferredLocalDates(D02_29_2018_SLASH, JLocalDates.NUMERIC_DATE_FORMATS)
        .size() == 0);
  }
  ...
  public final void testIsParsableStringStringArray() {
    ...
    assertTrue(
        JLocalDates.isParsable(D3_8_2016_SLASH, JLocalDates.MONTH_DAY_YEAR_NUMERIC_DATE_FORMATS));
    ...
    assertFalse(
        JLocalDates.isParsable(D02_13_2016_HYPEN, JLocalDates.DAY_MONTH_YEAR_NUMERIC_DATE_FORMATS));
