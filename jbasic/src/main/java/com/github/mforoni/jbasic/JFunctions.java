...
public final class JFunctions {
	 ...
	 * @see Function
	 */
	public static final Function<String, Integer> STRING_TO_INTEGER = new Function<String, Integer>() {
	 ...
	 * @see Function
	 */
	public static final Function<String, Boolean> STRING_TO_BOOLEAN = new Function<String, Boolean>() {
