...
public final class JLocalDates {
	...
	public static final String[] YEAR_MONTH_DAY_NUMERIC_DATE_FORMATS = Patterns.YEAR_MONTH_DAY_NUMERIC.getStrings();
	public static final String[] MONTH_DAY_YEAR_NUMERIC_DATE_FORMATS = Patterns.MONTH_DAY_YEAR_NUMERIC.getStrings();
	public static final String[] DAY_MONTH_YEAR_NUMERIC_DATE_FORMATS = Patterns.DAY_MONTH_YEAR_NUMERIC.getStrings();
	public static final String[] NUMERIC_DATE_FORMATS = JArrays.concat(YEAR_MONTH_DAY_NUMERIC_DATE_FORMATS, MONTH_DAY_YEAR_NUMERIC_DATE_FORMATS,
	...
	/**
	 * Returns a {@code LocalDate} if the given {@code text} can be parsed with the specified {@code pattern}.
	 * 
	 * @param text
	 *            the string date to parse
	 * @param pattern
	 *            the pattern used for parsing
	 * @return a {@code LocalDate} if the given {@code text} can be parsed with the specified {@code pattern}.
	...
	/**
	 * Returns a {@code LocalDate} if the given {@code text} can be parsed with the one of the specified
	 * patterns.
	 * 
	 * @param text
	 *            the string date to parse
	 * @param firstPattern
	 *            the first pattern to be used for parsing
	 * @param secondPattern
	 *            the second pattern to be used for parsing
	 * @param otherPatterns
	 * @return a {@code LocalDate} if the given {@code text} can be parsed with the one of the specified
	 *         patterns.
	 * @throws IllegalArgumentException
	 *             if the text to parse is invalid for all the specified patterns
	 */
	@Nonnull
	public static LocalDate parse(@Nonnull final String text, @Nonnull final String firstPattern, @Nonnull final String secondPattern,
			final String... otherPatterns) {
	...
	/**
	 * Returns a list of {@link InferredLocalDate} objects where each one contains the successful parsing of
	 * the given {@code text} using one of the format pattern of the array
	 * {@link JLocalDates#NUMERIC_DATE_FORMATS}. The parsing operation is performed with
	 * {@link DateTimeFormatter#parseDateTime(String)}. If no parsing is successful returns an empty list.
	 * 
	 * @param text
	 * @return a list of {@code InferredLocalDate} objects where each one contains the successful parsing of
	 *         the given {@code text}
	...
	@Nonnull
	public static List<InferredLocalDate> inferredLocalDates(@Nonnull final String text, @Nonnull final Patterns patterns) {
		return inferredLocalDates(text, patterns.getStrings());
	}

	@Nonnull
	public static List<InferredLocalDate> inferredLocalDates(@Nonnull final String text, @Nonnull final String[] patterns) {
	...
	public static class InferredLocalDate {
		...
		public InferredLocalDate(final LocalDate localDate, final String format, final String originalText) {
			super();
		...
		public String toString() {
			return "InferredLocalDate [localDate=" + localDate + ", format=" + format + ", originalText=" + originalText + "]";
		}
	}
}
