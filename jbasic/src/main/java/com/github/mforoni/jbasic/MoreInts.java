...
public final class MoreInts {
  ...
  /**
   * Returns an array of int primitives of length {@code n}, filled with random numbers between
   * {@code min} and {@code max} extremes included.
   * 
   * @param n the required array length
   * @param min the minimum integer value allowed
   * @param max the maximum integer value allowed
   * @return an array of int primitives of length {@code n}, filled with random numbers between
   *         {@code min} and {@code max} extremes included.
   */
  ...
  /**
   * Returns an array of int primitives of length {@code n}, filled with random numbers between
   * {@code 0} and {@code max} extremes included.
   * 
   * @param n the required array length
   * @param max the maximum integer value allowed
   * @return an array of int primitives of length {@code n}, filled with random numbers between
  ...
  /**
   * Returns a new array of int elements having the value {@code start} in the first position,
   * {@code start+1} in the second position and so on till {@code max} at the end.
   * 
   * @param start
   * @param end
   * @return a new array of int elements having the value {@code start} in the first position,
   *         {@code start+1} in the second position and so on till {@code max} at the end.
   */
  @Beta
