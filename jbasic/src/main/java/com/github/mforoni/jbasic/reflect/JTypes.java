...
public class JTypes {
	...
	@Nullable
	public static <T> Constructor<T> noArgsConstructor(final Class<T> type) throws IllegalStateException {
		try {
	...
	/**
	 * Returns the corresponding primitive type to specified primitive type wrapper. Returns <tt>null</tt> if the
	 * specified type is not a primitive type wrapper.
	 * <p>
	 ...
	 * 
	 * @param type
	 * @return the corresponding primitive type to specified primitive type wrapper. Returns <tt>null</tt> if the
	 *         specified type is not a primitive type wrapper.
	 * @see Class
	 */
	@Nullable
	...
	public static boolean isPrimitiveOrPrimitiveWrapper(final Class<?> type) {
		return (type.isPrimitive() && type != void.class) || type == Double.class || type == Float.class || type == Long.class
				|| type == Integer.class || type == Short.class || type == Character.class || type == Byte.class || type == Boolean.class;
	}
