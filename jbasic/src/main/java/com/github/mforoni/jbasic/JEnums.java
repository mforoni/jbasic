...
public final class JEnums {
  ...
  @Beta
  @Nonnull
  public static <E extends Enum<E>> E[] newArray(@Nonnull final Class<E> enumType,
      @Nonnull final E first, @Nonnull final E second, final E... others) {
  ...
  /**
   * Returns an array of strings containing all {@code Enum} constants' name property of the given
   * {@code Enum} type.
   * 
   * @param enumClass an {@code Enum} type
   * @return an array of strings containing all {@code Enum} constants' name property of the given
   *         {@code Enum} type
   * @see Enum
   */
  @Nonnull
  ...
  /**
   * Returns an {@link Optional} objects containing the {@code Enum} constant of the specified
   * {@code Enum} type having name equals to the given strings {@code constantName}.
   * 
   * @param enumClass an {@code Enum} type
   * @param constantName the name of the {@code Enum} constant
   * @return an {@link Optional} objects containing the {@code Enum} constant of the specified
   *         {@code Enum} type having name equals to the given strings {@code constantName}
   * @see Optional
   */
  public static <E extends Enum<E>> Optional<E> optionalValueOf(@Nonnull final Class<E> enumClass,
   ...
   * @param enumClass an {@code Enum} type
   * @param name
   * @return the {@code Enum} constant of the specified {@code Enum} type having name equals to the
   *         given strings {@code name} converted to upper case and whose occurrences of spaces are
