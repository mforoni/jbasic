...
public final class JLogger {
	...
	@Deprecated
	private static void log(final Level level, final Optional<Logger> optLogger, final Optional<Throwable> t, String msg, final Object... args) {
	...
	// TODO make private
	public static void log(@Nonnull final Level level, @Nonnull final Logger logger, @Nonnull final String msg) {
		switch (level) {
			case DEBUG:
				logger.debug(msg);
				break;
	...
	private static void log(final Level level, final Logger logger, final String msg, final Throwable t) {
		switch (level) {
			case DEBUG:
				logger.debug(msg, t);
				break;
	...
	public static <T> void info(@Nonnull final Collection<T> collection, @Nonnull final Function<T, String> toMessage) {
	...
	public static <T> void info(@Nonnull final T[] array, final int limit, @Nonnull final Function<T, String> toMessage) {
	...
	@Beta
	public static <T> void tailInfo(@Nonnull final T[] array, final int limit, final Function<T, String> toMessage) {
