...
public final class JStrings {
	 ...
	 * @param others
	 *            the others element of the array
	...
	/**
	 * Finds the similar strings in the specified {@link Collection} having minimum {@link Levenshtein}
	 * distance from the given {@code key}.
	 * 
	 * @param key
	 *            the string to search in the {@code Collection}
	 * @param collection
	 *            the {@code Collection} of strings
	 * @return a {@code Set} of strings having minimum {@link Levenshtein} distance from the given {@code key}
	 * @see Levenshtein
	 */
	@Nonnull
	 ...
	 * @param collection
	 *            the {@code Collection} of strings
	 * @return a {@code Set} of strings having minimum {@link MetricStringDistance} distance from the given
	 *         {@code key}
	 * @see MetricStringDistance
	 */
	@Nonnull
	public static Set<String> similars(final String key, final Collection<String> collection, final MetricStringDistance metricStringDistance) {
	 ...
	 */
	@Nonnull
	public static ImmutableSet<String> newImmutableSet(@Nonnull final String first, @Nonnull final String second, final String... others) {
		return ImmutableSet.<String>builder().add(first).add(second).add(others).build();
	}

	/**
	 * Returns <tt>true</tt> if the given {@code text} matches the specified {@code pattern}, <tt>false</tt>
	 * otherwise.
	 * 
	 * @param text
	 *            the text to match
	 ...
	 * @return <tt>true</tt> if the given {@code text} matches the specified {@code pattern}, <tt>false</tt>
	 *         otherwise.
	 * @see Pattern
	 */
	...
	/**
	 * Returns <tt>true</tt> if and only if {@code key} is equals to {@code first}, or {@code second}, or one
	 * of the strings in {@code others}, otherwise returns <tt>false</tt>.
	 * 
	 * @param key
	 *            the key to search
	 * @param first
	 ...
	 * @param others
	 *            the other strings
	 * @return <tt>true</tt> if and only if {@code key} is equals to {@code first}, or {@code second}, or
	 *         {@code others}
	 * @see String#equals(Object)
	 */
	@Beta
	public static boolean match(@Nonnull final String key, @Nonnull final String first, @Nonnull final String second, final String... others) {
		return newImmutableSet(first, second, others).contains(key);
	}

	@Beta
	public static boolean matchIgnoreCase(@Nonnull final String key, @Nonnull final String first, @Nonnull final String second,
			final String... others) {
	...
	@Beta
	public static String[] split(final String s, final char firstSeparator, final char secondSeparator, final char... otherSeparators) {
	...
	/**
	 * Returns a new string obtained by concatenating the given string {@code s} with itself the given number
	 * of {@code times}, using the specified string as {@code separator}.
	 * 
	 * @param s
	 *            the string to concatenate
	 * @param times
	 *            the times the concatenation need to be executed
	 * @param separator
	 *            the separator used
	 * @return the concatenation of the given string {@code s} with itself the given number of {@code times},
	 *         using the specified string as {@code separator}.
	 */
	@Nonnull
	public static String concat(@Nonnull final String s, final int times, @Nonnull final String separator) {
	 ...
	 * @param others
	 *            the other strings to concatenate
	 * @return a new string obtained by the concatenation of the given strings
	 */
	@Nonnull
	public static String concat(@Nonnull final String first, @Nonnull final String second, final String... others) {
	...
	/**
	 * Returns the string {@code s} with the character at position {@code index} converted in lower case.
	 *
	 * @param s
	 *            the string
	 * @param index
	 *            the index of the character to convert
	 * @return the string {@code s} with the character at position {@code index} converted in lower case.
	 */
	@Nonnull
	...
	/**
	 * Returns the string {@code s} with the character at position {@code index} converted in upper case.
	 *
	 * @param s
	 *            the string
	 * @param index
	 *            the index of the character to convert
	 * @return the string {@code s} with the character at position {@code index} converted in upper case.
	 */
	@Nonnull
	...
	/**
	 * Returns <tt>true</tt> if the string {@code s} contains one of the specified characters, <tt>false</tt>
	 * otherwise.
	 * 
	 * @param s
	 *            the string to check
	 ...
	 */
	public static boolean contains(@Nonnull final String s, final char first, final char second, final Character... others) {
		final ImmutableSet<Character> set = ImmutableSet.<Character>builder().add(first).add(second).add(others).build();
	...
	/**
	 * Returns a new string as the lower <a href= "https://en.wikipedia.org/wiki/CamelCase">Camel Case</a>
	 * version of the specified {@code text} having the given {@link CaseFormat}.
	 * 
	 * @param text
	 *            the text to convert
	 ...
	 */
	@Nonnull
	public static String lowerCamelCase(@Nonnull final String text, @Nonnull final CaseFormat caseFormat) {
		return CaseFormat.LOWER_CAMEL.to(caseFormat, text);
	}

	/**
	 * Returns the lower <a href= "https://en.wikipedia.org/wiki/CamelCase">Camel Case</a> version of the
	 * given phrase represented by the given list of strings where each string is treated as a word.
	 * 
	 * @param strings
	 *            a {@code List} of {@code String} objects
	...
	@Beta
	public static String lowerCamelCase(@Nonnull final String text, final char separator, final char... others) {
	 ...
	 *            the string
	 * @param index
	 *            the index to start the searching
	 * @return the string {@code s} truncated after the first consonant found after the index {@code index}.
	 */
	@Beta
	...
	/**
	 * Returns the index of the first consonant in the string {@code s}. Returns <tt>-1</tt> if no consonant
	 * is found.
	 *
	 * @param s
	 *            the string
	 * @return the index of the first consonant in the string {@code s}. Returns <tt>-1</tt> if no consonant
	 *         is found.
	...
	/**
	 * Returns the index of the first consonant in the string {@code s} starting the search from the index
	 * {@code fromIndex}, inclusive. Returns <tt>-1</tt> if no consonant is found.
	 *
	 * @param s
	 *            the string
	 * @param fromIndex
	 *            the starting index to check
	 * @return the index of the first consonant in the string {@code s} starting the search from the index
	 *         {@code fromIndex}, inclusive. Returns <tt>-1</tt> if no consonant is found.
	 * @see #indexOfConsonant(String, int, int)
	 */
	 ...
	 * {@code fromIndex}, inclusive, to the index {@code toIndex}, inclusive. Returns <tt>-1</tt> if no
	 * consonant is found.
	 *
	 * @param s
	 *            the string
	...
	/**
	 * Returns <tt>true</tt> if the string {@code s} is numeric, i.e. composed by just ISO Latin 1 digits,
	...
	/**
	 * Returns <tt>true</tt> if the string {@code s} is alphabetic, i.e. composed by just letters, otherwise
	 * returns <tt>false</tt>.
	 * <p>
	 ...
	 * <a href="https://en.wikipedia.org/wiki/ISO_basic_Latin_alphabet"> ISO basic Latin alphabet</a> i.e. the
	 * same characters of the English alphabet.
	 * 
	 * @param s
	 *            the string to check
	 * @return <tt>true</tt> if the specified string is composed only of characters from the ISO basic Latin
	 *         alphabet
	 */
	...
	@Nonnull
	public static String replaceNotAlphanumeric(@Nonnull final String s, @Nonnull final String replacement) {
	...
	/**
	 * Returns a new string from the given string {@code s}, eventually filled up at the beginning with the
	 * character {@code c} in order to reach the requested dimension {@code size}.
	 *
	 * @param s
	 *            a string
	 * @param size
	 *            an <tt>int</tt> representing the size to reach
	 * @param c
	 *            a <tt>char</tt> to use for fill the string to return
	 * @return a new string from the given string {@code s} eventually left filled up with the character
	 *         {@code c} in order to reach the requested dimension {@code size}
	 * @throws IllegalArgumentException
	 *             if the given {@code size} is lesser than the string length
	 */
	@Nonnull
	public static String padStart(@Nonnull final String s, final int size, final char c) {
		if (size < s.length()) {
			throw new IllegalArgumentException("The specified size must be at least equals to the string length");
