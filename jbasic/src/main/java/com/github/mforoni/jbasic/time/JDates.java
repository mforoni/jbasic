...
public final class JDates {
   ...
   * {@link java.sql.Date}, {@link LocalDate}, {@link DateTime}, or {@link LocalDateTime}; otherwise
   * returns <tt>false</tt>.
   * 
   * @param obj
  ...
  public static boolean isDateInstance(@Nonnull final Object obj) {
    return (obj instanceof java.util.Date || obj instanceof java.sql.Date
        || obj instanceof LocalDate || obj instanceof DateTime || obj instanceof LocalDateTime);
  }
}
