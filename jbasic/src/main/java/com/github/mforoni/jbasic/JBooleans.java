...
/**
 * Provides {@code static} utility methods for parsing strings into {@link Boolean} objects and the
...
public final class JBooleans {
   ...
   * <li><tt>false</tt> if the specified string parameter is equals ignoring case to no or
   * false</li>
