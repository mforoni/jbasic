...
/**
 * Workaround for different computer systems not always working with
 * {@code Desktop.getDesktop.open()}. This was taken from
 * http://stackoverflow.com/questions/18004150/desktop-api-is-not-supported-on-the-current-platform,
 * with some modifications made for simplicity and logging with slf4j2
 */
@Beta
public final class JDesktop {
  ...
  private static String[] prepareCommand(final String command, final String args,
      final String file) {
